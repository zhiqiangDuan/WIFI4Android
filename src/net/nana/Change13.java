...
public class Change13 extends Activity implements OnClickListener {
	...
	public void onClick(View arg0) {
        ...
        intent.setClass(Change13.this, Sendmsg.class);  
        intent.putExtra("data13", string);
        setResult(RESULT_OK, intent);
		Change13.this.finish();
