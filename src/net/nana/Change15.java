...
public class Change15 extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.change15);
		...
		butOK.setOnClickListener(Change15.this);
	...
	public void onClick(View arg0) {
        ...
        intent.setClass(Change15.this, Sendmsg.class);  
        intent.putExtra("data15", string);
        setResult(RESULT_OK, intent);
		Change15.this.finish();
