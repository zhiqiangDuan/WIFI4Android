...
public class Change5 extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.change5);
		rg = (RadioGroup)findViewById(R.id.radioGroup1);
		et1 = (EditText)findViewById(R.id.Text1);
		butOK.setOnClickListener(Change5.this);
	...
	public void onClick(View arg0) {
        ...
        intent.setClass(Change5.this, Sendmsg.class);  
        intent.putExtra("data5", string);
