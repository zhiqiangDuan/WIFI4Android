...
public class Change8 extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.change8);
		...
		butOK.setOnClickListener(Change8.this);
	}
	@Override
	public void onClick(View arg0) {
        ...
        intent.setClass(Change8.this, Sendmsg.class);  
        intent.putExtra("data8", string);
